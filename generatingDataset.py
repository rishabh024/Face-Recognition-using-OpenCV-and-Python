...
while True:
    ...
    # color of frame is converted to the gray color by using COLOR_BGR2GRAY property
    ...
    if(cv2.waitKey(1)==10 or count >= 40):    # if enter key is pressed or if no of images >= 40 then break the loop
        break
